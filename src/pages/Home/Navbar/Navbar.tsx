                ...
                <div className="flex items-center justify-between h-16">
                    ...
                    <div className="hidden md:block">
                        <div className="ml-4 flex items-center space-x-4">
                            ...
                            <a href="/allCar" className="text-white hover:bg-white hover:text-black rounded-lg p-2">All Car</a>
                            <a href="/login" className="text-white hover:bg-white hover:text-black rounded-lg p-2">Login</a>
                        </div>
                    </div>
            ...
            { isClick && (
                <div className="md:hidden">
                    ...
                    <a href="/" className="text-white block hover:bg-white hover:text-black rounded-lg p-2">Home</a>
                            ...
                            <a href="/allCar" className="text-white block hover:bg-white hover:text-black rounded-lg p-2">All Cars</a>
                            <a href="/login" className="text-white block hover:bg-white hover:text-black rounded-lg p-2">Login</a>
                    </div>
                </div>
            )}
        </nav>   
